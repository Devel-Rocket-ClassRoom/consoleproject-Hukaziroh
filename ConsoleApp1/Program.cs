        ...
        public void PlayGame(int stageCount)
        {
            ...
            for (int s = 0; s < stageCount; s++)
            {
                ...
                for (int i = 0; i < maxMonsters; i++)
                {
                    ...
                    enemies[i] = new Monster(4, 4, spawnPos.X, spawnPos.Y);
                ...
                {
                    Position spawnPos = map.GetRandomEmptyPosition();
                    enemies[maxMonsters + i] = new BossMonster(s, spawnPos.X, spawnPos.Y);
                ...
                while (!isGameOver)
                {
                    ...
                    else if (map.Maps[nextY, nextX] == 'M')
                    {
                        ...
                        {
                            int battleResult = battle.DoBattle(player, targetMonster);
                    ...
                    else if (map.Maps[nextY, nextX] == 'B')
                    {
                        ...
                        {
                            BossMonster targetBoss = null;
                            int targetIndex = -1;
                            for (int i = 0; i < enemies.Length; i++)
                            {
                                if (enemies[i] != null && enemies[i].Pos.X == nextX && enemies[i].Pos.Y == nextY)
                                {
                                    targetBoss = enemies[i] as BossMonster;
                                    targetIndex = i;
                                    break;
                                }
                            }
                            ...
                            if (targetBoss != null)
                            {
                                int battleResult = battle.DoBossBattle(player, targetBoss);
